...
text("AXEFX ULTRA EDIT REMAKE",x:44,y:483,size:16,color:amber,weight:.bold)
text("Your Ultra. A native Mac workspace.",x:44,y:441,size:26,color:.white,weight:.semibold)
text("Drag AxeFX Ultra Edit Remake to Applications to install.",x:44,y:410,size:14,color:NSColor(white:0.77,alpha:1))
...
text("\(version) beta  ·  First-launch guide included",x:350,y:28,size:12,color:.darkGray)
image.unlockFocus()
