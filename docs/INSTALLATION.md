...
Version 0.5.1 renamed the application to **AxeFX Ultra Edit Remake**. Quit the old app, install the new one, then remove the old **Ultra Edit.app** to avoid opening the wrong version. Your library, snapshots and preferences remain in their existing locations; no data migration is required.
